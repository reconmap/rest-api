...
INSERT INTO vulnerability (project_id,
                           target_id,
                           reported_by_uid,
                           category_id,
                           summary,
...
VALUES (1, 'goohost',
       ...
       (2, 'nmap', 'Scans all reserved TCP ports on the machine', 'instrumentisto/nmap',
        '-v scanme.nmap.org -oX nmap-output.xml'),
       (3, 'whois', 'Retrieves information about domain', 'zeitgeist/docker-whois', 'reconmap.org'),
       (4, 'sqlmap', 'Runs SQL map scan', 'paoloo/sqlmap',
        '-u mysql --method POST --data "username=foo&password=bar" -p username --level 5 --dbms=mysql -v 1 --tables');

INSERT INTO task (project_id, name, description, command_id)
VALUES (1,
        'Run port scanner',
       ...
       (1,
        ...
        'Use whois or other tools to check when the domain expiration is.', 1),
       (2,
        'Run port scanner',
